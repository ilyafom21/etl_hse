# Итоговое задание ETL по 4 модулю
...
Сам token.txt не был прикреплен в репозиторий по соображениям безопасности, так как содержит IAM-токен доступа к Yandex Cloud
